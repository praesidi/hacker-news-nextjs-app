	...
	return (
		<main className='max-w-[1280px] w-full flex flex-col items-center justify-center px-8'>
			...
			<div className='w-full flex justify-start mb-5'>
				<div className='h-7 w-[200px] bg-gray-300 dark:bg-gray-600 rounded animate-pulse'></div>
			</div>
			{/* comment tree */}
...
function CommentSkeleton() {
	return (
		<div className='w-full rounded py-1 px-3 border-l border-l-neutral-500 '>
			<div className='h-4 w-[160px] mb-2 rounded bg-gray-300 dark:bg-gray-600 animate-pulse'></div>
			<div className='flex w-full flex-col gap-2'>
				<div className='w-full h-4 rounded bg-gray-300 dark:bg-gray-600 animate-pulse'></div>
				<div className='w-full h-4 rounded bg-gray-300 dark:bg-gray-600 animate-pulse'></div>
				<div className='w-1/3 h-4 rounded bg-gray-300 dark:bg-gray-600 animate-pulse'></div>
			</div>
		</div>
	);
}
